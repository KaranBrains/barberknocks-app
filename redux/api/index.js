...
export const paymentUrl =
  "https://www.pigameapp.com:8081/api/create-checkout-session";
// rebuild
...
export const serviceSlot = (service, city) =>
  axios.get(`${url}/search-slot-city?service=${service}&city=${city}`);
...
export const getStylistById = (id) => axios.get(`${url}/stylist?id=${id}`);
...
export const endRide = (ride) => axios.get(`${url}/end-ride?ride=${ride}`);
...
export const giveFeedback = (formData, id) =>
  axios.post(`${url}/feedback?booking=${id}`, formData);
